...
# model (load weights and config)
pb = 'frozen_inference_graph_mobile_net.pb'
...
while True:
    ...
    for detection in cvOut[0, 0, :, :]:
        ...
        if score > 0.3:
            ...
            # Detecting what is needed! (introduce issues if all objects are detected)
            if classes[idx] == 'apple' or classes[idx] == 'banana' or classes[idx] == 'orange':
