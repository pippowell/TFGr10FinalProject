# modified version of the official EfficientNet feature extractor for SSD, all relevant copyright etc. information is included in the header below
# code for efficientnet versions not used is removed and naming changed to align with our custom files
...
# this is the base EfficientNet structure and code that the B0 version is based on - cannot be deleted!
...
# this is the official EfficientNet BO feature extractor which is equivalent
class EfficientNetFeatureExtractorOfficial(
